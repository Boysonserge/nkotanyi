...
<html lang="en">
<head>
    <title>Monst - Tailwind CSS Saas Landing Page</title>
    <meta charset="utf-8">
                ...
                <ul class="hidden lg:flex lg:items-center lg:w-auto lg:space-x-12">
                    <li class="group relative pt-4 pb-4 has-child">
                        ...
                        <ul class="drop-down-menu min-w-200">
                            <li>
                                <a href="index.html"
                                   class="menu-sub-item text-sm text-blueGray-600 hover:text-blueGray-500">Landing page
                                    1</a>
                            </li>
                            <li>
                                <a href="index-2.html"
                    ...
                    <li class="pt-4 pb-4">
                        <a class="text-sm font-semibold text-blueGray-600 hover:text-blueGray-500" href="about.html">About
                            Us</a>
                    </li>
                    <li class="pt-4 pb-4">
                        ...
                        <ul class="drop-down-menu min-w-200">
                            <li>
                                <a href="portfolio.html"
                                   class="menu-sub-item text-sm text-blueGray-600 hover:text-blueGray-500">Portfolio</a>
                            </li>
                            <li>
                                <a href="team.html"
                                   class="menu-sub-item text-sm text-blueGray-600 hover:text-blueGray-500">Team</a>
                            </li>
                            <li>
                                <a href="testimonials.html"
                                   class="menu-sub-item text-sm text-blueGray-600 hover:text-blueGray-500">Testimonials</a>
                            </li>
                            <li>
                                <a href="pricing.html"
                                   class="menu-sub-item text-sm text-blueGray-600 hover:text-blueGray-500">Pricing</a>
                            </li>
                            <li>
                                <a href="faqs.html"
                                   class="menu-sub-item text-sm text-blueGray-600 hover:text-blueGray-500">Faqs</a>
                            </li>
                            <li>
                                <a href="404.html"
                                   class="menu-sub-item text-sm text-blueGray-600 hover:text-blueGray-500">404</a>
                            </li>
                        </ul>
                    </li>
                    <li class="group relative pt-4 pb-4 has-child">
                        ...
                        <ul class="drop-down-menu min-w-200">
                            ...
                            <li>
                                <a href="blog-single.html"
                                   class="menu-sub-item text-sm text-blueGray-600 hover:text-blueGray-500">Single 1</a>
                            </li>
                            <li>
                                <a href="blog-single-2.html"
                                   class="menu-sub-item text-sm text-blueGray-600 hover:text-blueGray-500">Single 2</a>
                            </li>
                        </ul>
                    </li>
                    <li class="pt-4 pb-4"><a class="text-sm font-semibold text-blueGray-600 hover:text-blueGray-500"
        ...
        <nav
            ...
            <div class="mt-auto">
                <p class="my-4 text-xs text-blueGray-400">
                    ...
                    <a class="text-blue-500 hover:text-blue-500 underline" href="#"><span class="__cf_email__"
                                                                                          data-cfemail="5e3d31302a3f3d2a1e3331302d2a703d3133">[email&#160;protected]</span></a>
                </p>
                ...
                <div class="mt-12 mb-8 p-8 bg-white rounded shadow">
                    ...
                    <form action="{{ route('register2') }}" method="POST">
                        ...
                        <div class="flex mb-6 px-4 bg-blueGray-50 rounded border border-gray-200">
                            <input
                                class="w-full py-4 text-xs placeholder-blueGray-400 font-semibold leading-none bg-blueGray-50 outline-none"
                                type="password" id="password_confirmation" name="password_confirmation" placeholder="Re-Enter your password">
                            <button class="ml-4">
                                <svg class="h-6 w-6 my-auto text-blueGray-300" xmlns="http://www.w3.org/2000/svg"
                                     fill="none" viewbox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="w-full mt-12 mx-auto text-center">
                        <p class="text-sm">Already have an account? <a
                                ...
                                data-wow-delay=".1s" href="{{route('login2')}}">Sign in now</a></p>
                    </div>
                </div>
